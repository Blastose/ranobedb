...
<div
	class="bg-[#e4e7ee] dark:bg-dark-500 p-2 rounded-sm grid grid-cols-[1fr_75%] md:grid-cols-[150px_1fr] gap-x-2 shadow-sm"
>
	...
	<div class="flex flex-col gap-2">
		...
		after:bg-gradient-to-t after:from-[#e4e7ee] dark:after:from-dark-500
		"
		>
