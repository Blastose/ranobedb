...
<Dialog.Root bind:open>
	<Dialog.Trigger type="button" class="link-box round-full w-full max-w-xs py-[0.375rem]">
		Batch edit your books in series
	</Dialog.Trigger>
	<Dialog.Portal>
									...
									>
										...
										<div class="flex flex-col justify-end gap-2 sm:flex-row">
											<Dialog.Trigger
												disabled={$submitting}
												type="button"
												class="primary-btn w-full">Batch edit</Dialog.Trigger
											>
										</div>
									</form>
