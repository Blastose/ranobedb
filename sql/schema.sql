...
CREATE TABLE public.saved_filter (
    ...
    FOREIGN KEY (user_id) REFERENCES public.auth_user(id),
    PRIMARY KEY (user_id, item_name, is_list, name)
);
...
CREATE TABLE public.series (
    ...
    c_popularity integer NOT NULL DEFAULT 0,
    c_average integer NOT NULL DEFAULT 0,
    c_fully_translated public.language [] NOT NULL DEFAULT '{}',
    wikidata_id integer,
